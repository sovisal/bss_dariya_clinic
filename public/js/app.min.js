!(function (o, r, p) {
			...
			p(".custom-file input").change(function (e) {
				...
				p(".char-textarea").on("keyup", function (e) {
					!(function (e, a) {
						...
						p(".counter-value-"+ p(e).attr('id') +" .char-count").html(e.value.length),
							e.value.length > n
								? (p(".counter-value-"+ p(e).attr('id')).css("background-color", d), p(".char-textarea").css("color", d), p(".char-textarea").addClass("max-limit"))
								: (p(".counter-value-"+ p(e).attr('id')).css("background-color", "#5A8DEE"), p(".char-textarea").css("color", "#304156"), p(".char-textarea").removeClass("max-limit"));
					})(this, e),
	...
	p(".bookmark-wrapper .bookmark-star").on("click", function (e) {
		...
		p(".nav-link-search").on("click", function () {
			...
			e.val(""), e.addClass("open"),p(".search-input input").attr('disabled', false).focus(), p(".search-input .search-list li").remove(), p(".search-input .search-list").addClass("show");
		}),
		p(".search-input-close i").on("click", function () {
			...
			e.hasClass("open") &&
				...
				p(".search-input input").attr('disabled', true).blur(),
		...
		p(".app-content").on("click", function () {
			var e = p(".search-input-close"),
				z = p(".search-input input").attr('disabled', true),
