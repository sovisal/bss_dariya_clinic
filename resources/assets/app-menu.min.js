			...
			update: function () {
				if (this.obj) {
					if (!0 === r(".main-menu").data("scroll-to-active")) {
						var e, n, a;
						if (
							((e = o.querySelector(".main-menu-content li.active")),
							(n = o.querySelector(".main-menu-content")),
							l.hasClass("menu-collapsed") && r(".main-menu-content li.sidebar-group-active").length && (e = o.querySelector(".main-menu-content li.sidebar-group-active")),
