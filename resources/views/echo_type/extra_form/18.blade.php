...
<tr>
	...
	<td>
		<x-bss-form.input name="thickness_of_gallbladder_wall" :value="old('thickness_of_gallbladder_wall', !empty($row) && $row->thickness_of_gallbladder_wall ? $row->thickness_of_gallbladder_wall : 'is normal. The size of the bile ducts between the gallbladder  stone diameter~8.72mm mm')"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<x-bss-form.input name="bladder" :value="old('bladder', !empty($row) && $row->bladder ? $row->bladder : 'moderately full of urine. No intra vesicle lesion or calculi are presence.')"/>
	</td>
</tr>
<tr>
...
<tr>
	<td class="text-right">- Endometrial</td>
	<td>
		<x-bss-form.input name="endometrial" :value="old('endometrial', !empty($row) && $row->endometrial ? $row->endometrial : 'thin and regular.')"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<x-bss-form.input name="impression" :value="old('impression', !empty($row) && $row->impression ? $row->impression : 'GALLBLADDER STONE')"/>
	</td>
</tr>