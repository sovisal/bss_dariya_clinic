<tr>
	...
	<td>
		<x-bss-form.textarea name="liver" class="my-simple-editor" :value="old('liver', !empty($row) && $row->liver ? $row->liver : '')"><p>normal of size, homogeneous, echo structure has a big nodular </p><p>diameter~60,6mm x 63,9mm in right lobe .</p><p>No dilatation of the intra hepatic bile duct is seen, the common bile duct is normal in diameter</p><p>The diameter of the aorta is normal and no aneurysms are seen.</p></x-bss-form.textarea>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<x-bss-form.textarea name="impression" class="my-simple-editor" :value="old('impression', !empty($row) && $row->impression ? $row->impression : '')"><p>- CHC</p><p>- COLON TUMOUR</p><p>- ABDOMINO - ADENOPATHY</p></x-bss-form.textarea>
	</td>
</tr>