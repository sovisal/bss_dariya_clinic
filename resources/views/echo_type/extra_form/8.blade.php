...
<tr>
	...
	<td>
		<x-bss-form.input name="uterus" :value="old('uterus', !empty($row) && $row->uterus ? $row->uterus : 'No seen')"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<x-bss-form.input name="star1" :value="old('star1', !empty($row) && $row->star1 ? $row->star1 : 'No intra abdominal lymphadenopathy or free intraperitoneal fluid is')"/>
	</td>
</tr>
<tr>
	<td class="text-right">*</td>
	<td>
		<x-bss-form.input name="star2" :value="old('star2', !empty($row) && $row->star2 ? $row->star2 : 'The right iliac fosse (RIF)  inflammation appendix structure hypoechogenouse, diameter~6,8mm with free fluid around.')"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<x-bss-form.input name="impression" :value="old('impression', !empty($row) && $row->impression ? $row->impression : 'APPENDICITIS')"/>
	</td>
</tr>